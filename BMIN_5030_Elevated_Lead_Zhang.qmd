...
#heatmap overlaying ethnicity and insurance out of curiosity, can cross map other variables as well but this one was the most interseting
lead %>%
  filter(!is.na(overdue)) %>%
